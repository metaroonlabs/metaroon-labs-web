...
export function SectionTitle(props: SectionTitleProps) {
    ...
    return (
        <div className={"px-[25px] lg:px-[100px] relative mb-10"}>
            <div
                className="text-[50px] sm:text-[75px] md:text-[90px] lg:text-[120px] xl:text-[160px] 2xl:text-[200px] text-center font-semibold text-transparent bg-clip-text opacity-[15%] bg-gradient-to-b from-[#FFFFFF] from-20% to-[#131313] to-80%">
                {props.primaryTitle}
            </div>
