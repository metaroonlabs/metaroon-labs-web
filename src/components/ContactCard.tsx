...
export function ContactCard(props: ContactCardProps) {
    return (
        <div
            className={"group flex flex-col justify-between border-[1px] border-[#4A4A4A] rounded-[10px] lg:w-[300px] lg:h-[400px] md:w-[240px] md:h-[320px] sm:w-[210px] sm:h-[280px] w-[180px] h-[240px] p-[25px] hover:bg-[#FFFFFF] hover:text-black hover:cursor-pointer"}>
            ...
            <div className={'flex items-center justify-between bottom-0'}>
                <div className={'text-[14px] lg:text-[22px] md:text-[18px] font-[700] leading-[30.8px]'}>{props.title} {props.secondTitle &&
                    <>
                        <br/>
                        {props.secondTitle}
                    </>
                ...
                <div className={'flex-none'}>
                    <div className={'flex justify-center items-center rounded-full lg:w-[50px] lg:h-[50px] md:w-[45px] md:h-[45px] w-[32px] h-[32px] bg-white group-hover:bg-black'}>
