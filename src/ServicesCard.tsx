...
export function ServicesCard(props: ServicesCardProps) {
    ...
    return (
        <div
            className={"max-w-[236px] w-full h-[260px] bg-sky-500 rounded-[10px] overflow-hidden bg-gradient-to-br from-[#9D9D9D] via-[#202020] to-[#202020] p-[2px] group"}>
            <div
                className={"w-full h-full bg-[#131313] rounded-[10px] p-5 flex flex-col justify-between items-center"}>
                <div className={"relative w-[220px] h-[120px] flex justify-center items-center"}>
                    ...
                    <img src="/assets/images/services/grid.png" alt="grid-img"
                         className={"w-[170px] absolute top-[-5px] left-[25px] z-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"}/>
                    <div
                ...
                <div className={"w-full text-center"}>{props.title} {props.secondTitle &&
                    <>
                        <br/>
                        {props.secondTitle}
                    </>
