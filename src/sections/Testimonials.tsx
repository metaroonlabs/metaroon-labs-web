        ...
        <>
            ...
            <div className="flex justify-center gap-10 px-[100px]">
                <div className="flex flex-col justify-between">
                    <TestimonialCard
                        testimonial={"“Lorem ipsum dolor sit amet consectetur. Ac bibendum nunc egestas pulvinar sed. Non porta ultrices interdum duis gravida lectus. Vel morbi massa sit viverra nunc velit diam.i.”"}
                        username={"Vytas Butkevicius"} designation={"Founder at Outframe"}
                        imgUrl={"/assets/testimonial/avatar.png"}/>
                    <TestimonialCard
                        testimonial={"“Lorem ipsum dolor sit amet consectetur. Ac bibendum nunc egestas pulvinar sed. Non porta ultrices interdum duis gravida lectus. Vel morbi massa sit viverra nunc velit diam.i.”"}
                        username={"Vytas Butkevicius"} designation={"Founder at Outframe"}
                        imgUrl={"/assets/testimonial/avatar.png"}/>
                ...
                <TestimonialCard
                    ...
                    username={"Vytas Butkevicius"} designation={"Founder at Outframe"}
                    imgUrl={"/assets/testimonial/avatar.png"} largeCard={true}/>
            </div>
        </>
    );
}