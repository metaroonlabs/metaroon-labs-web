...
export function Contact() {
    return (
        <div>
            <div className={'grid grid-rows-2 grid-flow-col gap-[20px] md:gap-[30px] lg:p-[100px] md:p-[25px] p-[25px]'}>
                <div>
                    <div
                        className={'text-[32px] lg:text-[50px] md:text-[40px] font-[700] leading-[50px] text-transparent bg-clip-text bg-gradient-to-b from-[#FFFFFF] from-[41.84%] to-[#131313] to-[99%]'}>Contact
                        US
                    </div>
                </div>
                ...
                <div className={'row-span-2 grid grid-rows-2 grid-flow-col gap-[20px] md:gap-[30px] justify-end'}>
