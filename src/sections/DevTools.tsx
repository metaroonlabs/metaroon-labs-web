...
export function DevTools() {
    return (
        <div>
            ...
            <div className={"grid grid-cols-8 px-[25px] lg:px-[100px] text-[14px] font-[400] leading-[17.64px] text-[#999999]"}>
                ...
                <div className={'group flex flex-col gap-[54px] items-center'}>Mobile App
                    <div className={'grid grid-cols-1 items-center gap-[54px]'}>
                        ...
                        <DevToolCard imgUrl={"/assets/images/devTool/mobile/android-studio.png"} title={"Android Studio"}/>
